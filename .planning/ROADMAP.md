...
| 9 | WhatsApp bot | 🅿️ PARKED (out of stock) | Forward-a-link flow via Twilio. Deferred — Chrome extension covers the same distribution gap. Revisit when extension shows real DAUs. |
